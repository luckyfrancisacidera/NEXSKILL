...
namespace SkillSense.Persistence.Migrations
{
    ...
    [Migration("20260408160855_AddMockBillingSetupToCompanySubscriptions")]
    partial class AddMockBillingSetupToCompanySubscriptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillSense.Domain.Entities.CompanyAccountRequestEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PrimaryAdminFullName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("PrimaryAdminPhone")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("PrimaryAdminRole")
                        .IsRequired()
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");
                    ...
                    b.ToTable("company_account_requests", (string)null);
                });
            ...
            modelBuilder.Entity("SkillSense.Domain.Entities.CompanyInvitationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SkillSense.Domain.Entities.CompanyRequestDocumentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("CompanyAccountRequestId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CompanyAccountRequestId");

                    b.ToTable("company_request_documents", (string)null);
                });

            modelBuilder.Entity("SkillSense.Domain.Entities.CompanySubscriptionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("LastEnforcedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("MockPaymentMethod")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)");
            ...
            modelBuilder.Entity("SkillSense.Domain.Entities.HireEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CompanyId", "Status", "HiredAtUtc");

                    b.HasIndex("RecruiterId", "Status", "HiredAtUtc");
            ...
            modelBuilder.Entity("SkillSense.Domain.Entities.ResumeSubmissionEntity", b =>
                {
                    ...
                    b.Property<Guid?>("HiredByRecruiterId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("JobSeekerHistoryArchivedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("JobSeekerHistoryDeletedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("SkillSense.Domain.Entities.CompanyRequestDocumentEntity", b =>
                {
                    b.HasOne("SkillSense.Domain.Entities.CompanyAccountRequestEntity", "CompanyAccountRequest")
                        .WithMany("Documents")
                        .HasForeignKey("CompanyAccountRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CompanyAccountRequest");
                });
            ...
            modelBuilder.Entity("SkillSense.Domain.Entities.HireEntity", b =>
                {
                    b.HasOne("SkillSense.Domain.Entities.ResumeSubmissionEntity", "Application")
                        .WithOne("Hire")
                        .HasForeignKey("SkillSense.Domain.Entities.HireEntity", "ApplicationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("SkillSense.Domain.Entities.JobOfferEntity", "Offer")
                        .WithOne("Hire")
                        .HasForeignKey("SkillSense.Domain.Entities.HireEntity", "OfferId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
