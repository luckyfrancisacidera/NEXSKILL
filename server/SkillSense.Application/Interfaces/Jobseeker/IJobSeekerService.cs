...
namespace SkillSense.Application.Interfaces.Jobseeker
{
    public interface IJobSeekerService
    {
        ...
        Task<PagedResult<object>> GetMyApplicationsAsync(Guid userId, int pageNumber, int pageSize, string? search, string? status, DateTime? startDate, DateTime? endDate, CancellationToken ct = default);
        ...
        Task<object> GetApplicationDetailAsync(Guid userId, Guid applicationId, CancellationToken ct = default);
