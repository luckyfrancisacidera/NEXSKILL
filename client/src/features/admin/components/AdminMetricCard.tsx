...
export const AdminMetricCard = ({
  ...
  <Card className="rounded-2xl border border-zinc-200 bg-white dark:bg-zinc-900 dark:border-zinc-700 p-5 shadow-sm">
    <div className="flex items-start justify-between gap-3">
      <div>
        <p className="text-sm font-medium text-zinc-500 dark:text-zinc-100">{label}</p>
