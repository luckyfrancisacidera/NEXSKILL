        ...
        {/* Left panel */}
          ...
          <div className='flex justify-center font-inter items-center bg-zinc-800 p-8'>
             <div className='w-full max-w-md'>
                 ...
                 <div className='mb-8'>
                    <h1 className='text-3xl font-bold tracking-wider text-white'>Sign in</h1>
                    <p className='text-sm text-zinc-400 mt-2'>Enter your credentials to access your account.</p>
                 </div>
