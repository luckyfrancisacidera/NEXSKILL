...
export const JobDetailPage = () => {
  ...
  const responsibilities = useMemo(() => toList(job.responsibilities), [job.responsibilities]);
  const benefits = useMemo(() => toList(job.benefits), [job.benefits]);
            ...
            <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_260px]">
              <div className="space-y-4">
                <DetailBlock title="About the Role">
                  <p className="whitespace-pre-wrap leading-7 text-zinc-700">{job.description || 'No description provided.'}</p>
                </DetailBlock>
              ...
              <aside className="space-y-3 lg:sticky lg:top-4 lg:self-start">
                ...
                <Form method="post" action={`/recruiter/job-posts/${job.id}/delete`}>
                  <button
                    type="submit"
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card>
          ...
          <div className="h-50">
            <ResponsiveContainer>
              <BarChart data={trend}>
                <Bar dataKey="applications" fill="#525252" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
