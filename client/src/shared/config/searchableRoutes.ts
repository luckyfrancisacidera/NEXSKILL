...
export const searchableRoutes: SearchableRouteItem[] = [
  ...
  },
  {
    ...
    label: "Profile",
    description: "Update your personal details and resume-facing information.",
    path: "/profile",
    section: "Jobseeker",
    roles: ["jobseeker"],
    keywords: ["account", "cv", "resume profile", "personal info"],
    icon: UserRound,
  },
  {
  ...
  },
  {
    ...
    description: "Manage recruiter settings and company-related preferences.",
    path: "/recruiter/settings",
    section: "Recruiter",
    roles: ["recruiter"],
    keywords: ["settings", "company profile", "recruiter settings", "preferences"],
    icon: Settings,
  },
  {
