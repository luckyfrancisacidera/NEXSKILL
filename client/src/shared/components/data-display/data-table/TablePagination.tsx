...
import type { TablePageSizeOption } from "@shared/components/data-display/data-table/TablePageSizeControl";
...
export const TablePagination = ({
  ...
  totalCount,
  pageSize,
  pageSizeOptions: _pageSizeOptions = [10, 20, 50],
  onPageChange,
  getPageHref,
  ...
  return (
    <div
      className={cn(
        "flex w-full min-w-0 max-w-full items-center justify-between gap-2 border-t border-zinc-200 px-3 py-3 text-xs text-zinc-500 dark:border-zinc-800 dark:text-zinc-400 max-[399px]:flex-wrap sm:px-4 sm:py-3.5 sm:text-sm",
        className,
      )}
    >
      <div className="flex min-w-0 max-w-full shrink items-center gap-2 overflow-hidden">
