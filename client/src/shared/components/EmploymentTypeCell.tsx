...
import { getEmploymentTypeIcon } from "@shared/utils/employmentTypeIcons";
...
export const EmploymentTypeCell = ({
  type,
  fallbackLabel = "-",
  className,
  labelClassName,
}: EmploymentTypeCellProps) => {
  const label = type?.trim() || fallbackLabel;
