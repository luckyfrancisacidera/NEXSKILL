...
export const EmailVerificationModal = ({
  ...
  return (
    <ModalOverlay onClose={onCancel}>
      <Card className="w-full min-w-0 rounded-[30px] border border-zinc-200 bg-white p-0 shadow-[0_30px_80px_rgba(15,23,42,0.2)] dark:border-zinc-800 dark:bg-zinc-950">
